 ...
 * RESET:               GPIOB, GPIO_PIN_3
 * GPIO0:               GPIOA, GPIO_PIN_0
 * GPIO2:               GPIOA, GPIO_PIN_3
...
#ifndef LWESP_STM32F103C8_H
#define LWESP_STM32F103C8_H
...
/* USART TX PIN */
#define LWESP_USART_TX_PORT_CLK               LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOA)
#define LWESP_USART_TX_PORT                   GPIOA
#define LWESP_USART_TX_PIN                    LL_GPIO_PIN_9

/* USART RX PIN */
#define LWESP_USART_RX_PORT_CLK               LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOA)
#define LWESP_USART_RX_PORT                   GPIOA
#define LWESP_USART_RX_PIN                    LL_GPIO_PIN_10

/* RESET PIN */
//#define LWESP_RESET_PORT_CLK                  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOB)
//#define LWESP_RESET_PORT                      GPIOB
//#define LWESP_RESET_PIN                       LL_GPIO_PIN_3

/* GPIO0 PIN */
//#define LWESP_GPIO0_PORT_CLK                  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOA)
//#define LWESP_GPIO0_PORT                      GPIOA
//#define LWESP_GPIO0_PIN                       LL_GPIO_PIN_0

/* GPIO2 PIN */
//#define LWESP_GPIO2_PORT_CLK                  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOA)
//#define LWESP_GPIO2_PORT                      GPIOA
//#define LWESP_GPIO2_PIN                       LL_GPIO_PIN_3

/* CH_PD PIN */
//#define LWESP_CH_PD_PORT_CLK                  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOA)
//#define LWESP_CH_PD_PORT                      GPIOA
//#define LWESP_CH_PD_PIN                       LL_GPIO_PIN_4

#endif /* LWESP_STM32F103C8_H */
